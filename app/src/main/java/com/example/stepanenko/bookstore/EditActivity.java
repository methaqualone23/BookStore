...
public class EditActivity extends AppCompatActivity implements
    ...
    private void saveData() {
        ...
        String priceString = bindPriceEditText.getText().toString().trim();
        String quantityString = bindQuantityEditText.getText().toString().trim();
        String supplierString = bindSupplierEditText.getText().toString().trim();
        String supplierPhoneString = bindSupplierPhoneEditText.getText().toString().trim();
  ...
  /*      switch (item.getItemId()) {
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            bindPriceEditText.setText(price);
